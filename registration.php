<?php
	...
	<head>
	    ...
	    <title>Apbiharpower.in - Registration</title>
							...
							<div class="registermain">
						    	...
						    	<div class="regform">
						    	    ...
						    	    <div class="formleftside">
                						    	 ...
                						    	 <div class="col-sm-4">
                						    	  ...
                						    	  <div class="col-sm-4">
                						    	   ...
                						    	   <div class="row">
                    						    	...
                    						    	<input type="text" pattern="[0-9]{12}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" onKeyDown="if(this.value.length==12 && event.keyCode!=8) return false;" 
                    						    	title="Please enter a valid aadhar number" name="aadhaarno" required>
                    						    	</div>
                    						    	
                    						    	<div class="col-sm-3">    
                    						    	<label>Mobile No:</label><br>
                    						    	<input  type="text" id="rphone" pattern="[6-9]{1}[0-9]{9}" name="mobno" title="Please enter a valid phone number" 
                    						    	oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" onKeyDown="if(this.value.length==10 && event.keyCode!=8) return false;" required>
                    						    	</div>
    						    	    ...
    						    	    <h4>Permanent Address:- </h4>
    						    	     ...
    						    	     <div class="formdivpi">
        						    	    ...
        						    	    <input type="text" pattern="[0-9]{6}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" onKeyDown="if(this.value.length==6 && event.keyCode!=8) return false;" 
                    						    	title="Please enter a valid pincode" name="pincode" required><br><br>
        						    	    </div>
        						    	    </div>
        						    	  </div><br><br><br>
        						    	...
        						    	<div class="formpi col-sm-12">
        						    	 ...
        						    	 <div class="formdivpi">
        						    	    ...
        						    	    <input type="text" name="accounthname" id="accounthname" required>
        						    	    	...
        						    	    	<div class="formpi col-sm-12">
        						    	    	    <h4>Registration Fee details:- </h4></div><br><br>
        						    	    	    <ul>
						    	    ...
						    	    <script
                                        ...
                                        data-key="rzp_live_qfZTHJ6CFHUMc0" 
                                        data-amount="10000"
                                        data-currency="INR"
