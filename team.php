	...
	<head>
	    ...
	    <title>Anjali & Poonam Power Services Pvt. Ltd - Our Team</title>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<h1>Our Team in our Company</h1>
                                        ...
                                        <ul class="one">
                                          <li class="transition">
                                            <div class="wrapper"> <img class="transition" src="img/team/cmd.jpg">
                                              <ul class="social">
                                              ...
                                              <i class="hhide">more</i></span> </div>
                                          </li>
                                          <li class="transition">
                                            <div class="wrapper"> <img class="transition" src="img/team/sweta.jpeg">
                                              <ul class="social">
                                                <li> Senior-HR <br>
